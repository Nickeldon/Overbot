...
global.client.on('messageCreate', message => {
  ...
  try {
    ...
    //console.error('no previous interaction')
  }}
  ...
  const Interval = 60 * 60 * 1000;
    ...
    /*const actions = {
      confirm_order(contextMap) {
        return {context_map: {...contextMap, order_confirmation: 'GEASS'}};
      },
    };*/
    ...
    /*console.log(client.message('Lelouch Vi Britannia vous ordonne!'));*/
